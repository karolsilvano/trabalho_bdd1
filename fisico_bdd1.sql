...
CREATE TABLE investimento (
    ...
    FK_cpf_pessoa CHAR(11),
    valor_investimento DECIMAL(7, 2),
    FOREIGN KEY (FK_cpf_pessoa) REFERENCES pessoa(cpf_pessoa) 
);
...
CREATE TABLE atribuicao (
    ...
    PRIMARY KEY(FK_cpf_pessoa, FK_cod_processo, FK_cod_estagiario),
    FOREIGN KEY(FK_cpf_pessoa) REFERENCES pessoa(cpf_pessoa),
    FOREIGN KEY (FK_cod_processo) REFERENCES processo(cod_processo),
    FOREIGN KEY (FK_cod_estagiario) REFERENCES estagiario(cod_estagiario)
);
...
CREATE TABLE agendamento (
	cod_agendamento INT AUTO_INCREMENT,
	FK_cod_estagiario INT,
	FK_oab_adv CHAR(15),
